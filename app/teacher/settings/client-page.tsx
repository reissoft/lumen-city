        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 text-white">
            ...
            <div className="container mx-auto p-4 md:p-8 relative max-w-3xl">
                ...
                <header className="mb-10">
                    <h1 className="text-4xl font-bold">Configurações do Perfil</h1>
                    ...
                    <div className="space-y-6">
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <Input id="name" name="name" defaultValue={teacher.name ?? ''} className={inputStyles} />
                                {getFieldError('name') && <p className="text-sm text-red-400 mt-1">{getFieldError('name')}</p>}
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="email" className="font-semibold">E-mail</Label>
                                <Input id="email" name="email" type="email" defaultValue={teacher.email ?? ''} className={inputStyles} />
                        ...
                        <div className="space-y-2 bg-white/5 p-4 rounded-lg border border-yellow-500/20">
                            <Label htmlFor="currentPassword" className="font-semibold text-yellow-300">Senha Atual (Obrigatório)</Label>
                             <p className="text-sm text-white/60 -mt-1 mb-3">Para salvar as alterações, você precisa confirmar sua senha atual.</p>
